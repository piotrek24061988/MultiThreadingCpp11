...
struct sorter
{
    ...
    list<T> do_sort(list<T> & chunk_data)
    {
        ...
        chunks.push(move(new_lower_chunk));//push first sublist to stack holding sublists
...
int main()
{
    list<int> l { 1, 34, 424, 56, 65, 2, 556, 54, 78, 45, 87, 79, 88, 99, 5556, 564, 7, 8, 0, 678, 242, 465, 876, 43, 655};
